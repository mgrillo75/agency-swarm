...
class AdvancedClassificationTechniques(BaseTool):
    """
    A tool that employs advanced classification techniques to categorize internal communications
    and tasks. It uses machine learning models to accurately classify and sort incoming messages
    based on content, urgency, and relevance.
    """
    ...
    message: str = Field(
        ..., description="The content of the communication or task to classify."
    )
